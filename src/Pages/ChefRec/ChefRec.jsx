    ...
    return (
        <div className='mb-16'>
            ...
            <div className='text-center bg-gray-100'>
                <img className='w-full h-[350px]' src={slide1} alt="" srcset="" />
            ...
            <div className='text-center bg-gray-100'>
                <img className='w-full h-[350px]' src={slide2} alt="" srcset="" />
                 <p className='text-xl font-bold mt-3'>Caeser Salad</p>
                 <p>Lettuce, Eggs, Parmesan Cheese, Chicken Breast Fillets.</p>
            ...
            <div className='text-center bg-gray-100'>
                <img className='w-full h-[350px]' src={slide3} alt="" srcset="" />
                 <p className='text-xl font-bold mt-3'>Caeser Salad</p>
                 <p>Lettuce, Eggs, Parmesan Cheese, Chicken Breast Fillets.</p>
                 <button className='uppercase mb-5 mt-2 text-[#BB8506] px-5 py-3 rounded-md border-b-2 border-[#BB8506] bg-gray-200'>Add To Cart</button>
            </div>
